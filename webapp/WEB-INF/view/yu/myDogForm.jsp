		...
		<div id="container" class="clearfix">
			...
			<div id="content" >
				...
				<div id="content-main">
					...
					<c:if test="${empty mvo}">
						<form id="myDogForm" action="${pageContext.request.contextPath}/mydogInsert" enctype="multipart/form-data"  method="get">
							<div id="dogCard">
								<div class="row"></div>
								<div id="cardHeader">
					...
					<c:if test="${!empty mvo}">
						<form id="myDogForm" action="${pageContext.request.contextPath}/mydogUpdate" enctype="multipart/form-data"  method="get">
							<div id="dogCard">
								<div class="row"></div>
								<div id="cardHeader">
									<p id="headerText" class="text-center">강아지 등록증</p>
