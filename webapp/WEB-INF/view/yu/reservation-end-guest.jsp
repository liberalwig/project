					...
					<div class="modal-body">
						...
						<div class="star row">
							<div class="rate col-md-6">
								...
								<div class="rating">
									<input type="radio" name="food" class="rating__control screen-reader" id="food1" value=2> 
									<input type="radio" name="food" class="rating__control screen-reader" id="food2" value=4> 
									<input type="radio" name="food" class="rating__control screen-reader" id="food3" value=6> 
									<input type="radio" name="food" class="rating__control screen-reader" id="food4" value=8> 
									<input type="radio" name="food" class="rating__control screen-reader" id="food5" value=10> 
							...
							<div class="rate col-md-6">
								...
								<div class="rating">
									<input type="radio" name="walk" class="rating__control screen-reader" id="walk1" value=2> 
									<input type="radio" name="walk" class="rating__control screen-reader" id="walk2" value=4> 
									<input type="radio" name="walk" class="rating__control screen-reader" id="walk3" value=6> 
									<input type="radio" name="walk" class="rating__control screen-reader" id="walk4" value=8> 
									<input type="radio" name="walk" class="rating__control screen-reader" id="walk5" value=10> 
						...
						<div class="star row">
							<div class="rate col-md-6">
								...
								<div class="rating">
									<input type="radio" name="clean" class="rating__control screen-reader" id="clean1" value=2> 
									<input type="radio" name="clean" class="rating__control screen-reader" id="clean2" value=4> 
									<input type="radio" name="clean" class="rating__control screen-reader" id="clean3" value=6> 
									<input type="radio" name="clean" class="rating__control screen-reader" id="clean4" value=8> 
									<input type="radio" name="clean" class="rating__control screen-reader" id="clean5" value=10> 
							...
							<div class="rate col-md-6">
								...
								<div class="rating">
									<input type="radio" name="play" class="rating__control screen-reader" id="play1" value=2> 
									<input type="radio" name="play" class="rating__control screen-reader" id="play2" value=4> 
									<input type="radio" name="play" class="rating__control screen-reader" id="play3" value=6> 
									<input type="radio" name="play" class="rating__control screen-reader" id="play4" value=8> 
									<input type="radio" name="play" class="rating__control screen-reader" id="play5" value=10> 
						...
						<div class="row">
							<div class="rate col-md-6">
								...
								<div class="rating">
									<input type="radio" name="communication" class="rating__control screen-reader" id="communication1" value=2> 
									<input type="radio" name="communication" class="rating__control screen-reader" id="communication2" value=4> 
									<input type="radio" name="communication" class="rating__control screen-reader" id="communication3" value=6> 
									<input type="radio" name="communication" class="rating__control screen-reader" id="communication4" value=8> 
									<input type="radio" name="communication" class="rating__control screen-reader" id="communication5" value=10> 
